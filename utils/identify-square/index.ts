...
/**
 * A function that returns the current square (3 x 3)
 * @param input An object with a 9x9 Sudoku grid, a row index and a column index
 */
function identifySquare({ grid, row, col }: IInput): SQUARE {
